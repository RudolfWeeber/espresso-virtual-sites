...
// This file contains the "center of mass" implementatio for virtual sites.
// Virtual sites are placed at the center of a molecule
// Forces acting on the center of mass are equally distributed to all particles
// of the molecule.
